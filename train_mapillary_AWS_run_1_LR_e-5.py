...
AWS_run_1_dir = os.path.join(DATASET_DIR, "AWS_run_1")

# Training dataset
dataset_train = MapillaryDataset()
dataset_train.load_mapillary(AWS_run_1_dir, "train_4096", class_ids = labels)
dataset_train.prepare()

# Validation dataset
dataset_val = MapillaryDataset()
dataset_val.load_mapillary(AWS_run_1_dir, "dev_512", class_ids = labels)
dataset_val.prepare()
