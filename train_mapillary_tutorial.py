...
dataset_train.load_mapillary(DATASET_DIR, "AWS_run_3/testing_1024", class_ids = labels)
dataset_train.prepare()

# Validation dataset
dataset_val = MapillaryDataset()
dataset_val.load_mapillary(DATASET_DIR, "AWS_run_3/testing_1024", class_ids = labels)
dataset_val.prepare()
