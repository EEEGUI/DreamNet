...
class MapillaryConfig(coco.CocoConfig):
    ...
    NUM_CLASSES = 1 + 37  # background + 11 objects
...
AWS_run_2_dir = os.path.join(DATASET_DIR, "CPU_pilot_run")

# Training dataset
dataset_train = MapillaryDataset()
dataset_train.load_mapillary(AWS_run_2_dir, "train_20", class_ids = labels)
dataset_train.prepare()

# Validation dataset
dataset_val = MapillaryDataset()
dataset_val.load_mapillary(AWS_run_2_dir, "dev_10", class_ids = labels)
dataset_val.prepare()
